...
const AboutMe =() =>{
    ...
    return(
        <div className="about-me">
            <h1>About Me</h1>
     <img src ="https://images.ctfassets.net/9wtva4vhlgxb/1MCz9x0Dg9iG6DJOqpqb1H/fb0cd8d03d20036a88cdcc28763264e1/Unique_baby_boy_names_720x432.jpg?fm=webp&q=70" alt="boy"></img>
